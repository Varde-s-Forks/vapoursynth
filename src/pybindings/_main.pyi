...
class CoreTimings:
    ...
    def get_graph(self, node: RawNode, mode: Literal["simple", "full", "times"] = "full", processing_time: float = 0.0) -> str: ...
    def get_filter_time(self, node: RawNode, processing_time: float) -> str: ...
...
class RawNode:
    ...
    def get_graph(self, mode: Literal["simple", "full", "times"] = "full", processing_time: float = 0.0) -> str: ...
    def get_filter_time(self, processing_time: float) -> str: ...
